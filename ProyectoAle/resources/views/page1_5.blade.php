                                 ...
                                 <center>
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text"   size="30" class=" form-control" id="exampleInputPassword1" name='exampleInputPassword1' placeholder="Usuarios que usaras en Netflix"  required/>
                                   </div> <br><br>
                                   <div class="form-group">
                                     ...
                                     <input type="password" id="password_user" name="password_user"   size="30" class=" form-control" id="exampleInputPassword1" placeholder="Contraseña para tu cuenta" required/>
                                       ...
                                       <div class="alertsize alert alert-info alert-dismissable">
                                        ...
                                        <h4>{{$name}}, Realiza tu pago Plan Premium 290$Arg</h4>
                                      
                                        
                                        <iframe src= "http://mpago.la/xRVR" height="500" width="900" ></iframe>
...
<!--     
   ...
   -->         
   <script>
   $("#exampleInputPassword1").val('{{$name}}');
  </script>
